...
Experiments that began from public templates are not included as original portfolio case studies. If a template-derived example is added later, its source and the extent of the changes must be stated clearly in that case study.
